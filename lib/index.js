...
Mainspring = function(date1, date2) {
  var CONSTANTS, diffBetweenTimes, extractTimeElement, spellOut;
  if (date2 == null) {
    date2 = new Date();
  }
  CONSTANTS = {
  ...
  diffBetweenTimes = function(date1, date2) {
    var diff, future;
    if (date1 > date2) {
      diff = date1 - date2;
      future = true;
  ...
  extractTimeElement = function(time, value, constant) {
    var elapsed;
    if (time > constant) {
